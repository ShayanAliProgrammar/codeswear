...
<head>
    ...
    <script src="{{ asset('build/app-feature-like-qwik.js') }}" defer></script>
    ...
    <script type="speculationrules">
        {
            "prefetch": [
                {
                    "source": "list",
                    "urls": [{{ route('all-products') }}, {{ route('about') }}]
                }
            ]
        }
    </script>
...
<body>
    ...
    <aside class="fixed right-0 bottom-0 flex flex-col-reverse gap-2 p-2 pb-10">
        @stack('toasts')
    </aside>
</body>
